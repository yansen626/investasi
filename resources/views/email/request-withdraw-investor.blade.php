...
<head>
    ...
    <title>Indofund.id - Permintaan Penarikan Dana</title>
    <style type="text/css">
            ...
            <td align="center" bgcolor="#fff" class="vb-outer" style="padding-left: 9px;padding-right: 9px;background-color: #fff;" valign="top">
                ...
                <div class="oldwebkit" style="max-width: 570px;">
                    <table bgcolor="#FFFFFF" border="0" cellpadding="0" cellspacing="9" class="vb-container halfpad" style="border-collapse: separate;border-spacing: 9px;padding-left: 9px;padding-right: 9px;width: 100%;max-width: 570px;background-color: #fff;" width="570">
                        <tbody>
                        <tr>
                            <td align="center" bgcolor="#FFFFFF" style="background-color: #ffffff; font-size: 22px; font-family: Verdana, Geneva, sans-serif; color: #3f3f3f; text-align: center;"><span>Kepada Yth Bapak/Ibu {{ $user->first_name . ' ' . $user->last_name }}</span></td>
                        </tr>
                        <tr>
                            <td bgcolor="#FFFFFF" style="background-color: #ffffff; font-size: 16px; font-family: Verdana, Geneva, sans-serif; color: #3f3f3f;">Kami menerima instruksi penarikan dana yang ditujukan ke Rekening {{ $statement->bank_name }} {{ $statement->bank_acc_number }} atas nama {{ $statement->bank_acc_name }}</td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td bgcolor="#FFFFFF" style="background-color: #ffffff; font-size: 16px; font-family: Verdana, Geneva, sans-serif; color: #3f3f3f;">IP: {{ $ipAddress }}</td>
                        </tr>
                        <tr>
                            <td bgcolor="#FFFFFF" style="background-color: #ffffff; font-size: 16px; font-family: Verdana, Geneva, sans-serif; color: #3f3f3f;">Nama: {{ $user->first_name }} {{ $user->last_name }}</td>
                        </tr>
                        </tbody>
                    </table>
                </div><!--[if (gte mso 9)|(lte ie 8)]></td></tr></table><![endif]-->

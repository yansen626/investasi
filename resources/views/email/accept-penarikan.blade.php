...
<center>
    <!-- preheaderBlock -->
    <!-- /preheaderBlock -->
    <table bgcolor="#fff" border="0" cellpadding="0" cellspacing="0" class="vb-outer" id="ko_logoBlock_5" style="background-color: #fff;" width="100%">
        <tbody>
        <tr>
                        ...
                        <tr>
                            <td align="center" valign="top">
                                ...
                                <div class="mobile-full" style="display: inline-block; max-width: 166px; vertical-align: top; width: 100%;">
                                    <a href="www.indofund.id" style="font-size: 18px; font-family: Arial, Helvetica, sans-serif; color: #f3f3f3; text-decoration: none;" target="_new"><img alt="" border="0" hspace="0" src="https://mosaico.io/srv/f-dtn0k95/img?src=https%3A%2F%2Fmosaico.io%2Ffiles%2Fdtn0k95%2Flogo%2520%25282%2529.png&amp;method=resize&amp;params=350%2Cnull" style="border: 0px;display: block;width: 100%;max-width: 166px;" vspace="0" width="166"></a>
            ...
            <td align="center" bgcolor="#fff" class="vb-outer" style="padding-left: 9px;padding-right: 9px;background-color: #fff;" valign="top">
                ...
                <div class="oldwebkit" style="max-width: 570px;">
                    <table bgcolor="#FFFFFF" border="0" cellpadding="0" cellspacing="9" class="vb-container halfpad" style="border-collapse: separate;border-spacing: 9px;padding-left: 9px;padding-right: 9px;width: 100%;max-width: 570px;background-color: #fff;" width="570">
                        ...
                        <tr>
                            <td bgcolor="#FFFFFF" style="background-color: #ffffff; font-size: 16px; font-family: Verdana, Geneva, sans-serif; color: #3f3f3f;">Kami telah memproses penarikan dana Anda dengan detail sebagai berikut:</td>
                        </tr>
                        <tr>
                            <td bgcolor="#FFFFFF" style="background-color: #ffffff; font-size: 16px; font-family: Verdana, Geneva, sans-serif; color: #3f3f3f;"><b>Rupiah Ditarik</b> : Rp {{ $statement->amount }}</td>
                        </tr>
                        <tr>
                            <td bgcolor="#FFFFFF" style="background-color: #ffffff; font-size: 16px; font-family: Verdana, Geneva, sans-serif; color: #3f3f3f;"><b>Biaya</b> : Rp {{ $statement->fee }}</td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td bgcolor="#FFFFFF" style="background-color: #ffffff; font-size: 16px; font-family: Verdana, Geneva, sans-serif; color: #3f3f3f;"><b>Waktu Kirim</b> : {{ $statement->created_on }}</td>
                        </tr>
                        <tr>
                            <td bgcolor="#FFFFFF" style="background-color: #ffffff; font-size: 16px; font-family: Verdana, Geneva, sans-serif; color: #3f3f3f;"><b>Bukti Transfer</b> :</td>
                        </tr>
                        <tr>
                            <td bgcolor="#FFFFFF" style="background-color: #ffffff; font-size: 16px; font-family: Verdana, Geneva, sans-serif; color: #3f3f3f;">Transfer dilakukan melalui jaringan LLG (kliring) atau RTGS. Dana akan sampai pada rekening Anda dalam 1 hari kerja bank.</td>
                        </tr>
                        </tbody>
                    </table>
                </div><!--[if (gte mso 9)|(lte ie 8)]></td></tr></table><![endif]-->
    ...
    <table bgcolor="#3F3F3F" border="0" cellpadding="0" cellspacing="0" id="ko_footerBlock_2" style="background-color: #3f3f3f;" width="100%">
        ...
        <tr>
            <td align="center" bgcolor="#3F3F3F" style="background-color: #3f3f3f;" valign="top">
                <!--[if (gte mso 9)|(lte ie 8)]><table align="center" border="0" cellspacing="0" cellpadding="0" width="570"><tr><td align="center" valign="top"><![endif]-->
                <div class="oldwebkit" style="max-width: 570px;">
                    <table align="center" border="0" cellpadding="0" cellspacing="9" class="vb-container halfpad" style="border-collapse: separate;border-spacing: 9px;padding-left: 9px;padding-right: 9px;width: 100%;max-width: 570px;" width="570">
                        <tbody>
                        <tr>

...
<head>
    ...
    <title>Indofund.id - Pembelian</title>
    <style type="text/css">
        ...
        <tr>
            <td align="center" bgcolor="#fff" class="vb-outer" style="padding-left: 9px;padding-right: 9px;background-color: #fff;" valign="top">
                ...
                <div class="oldwebkit" style="max-width: 570px;">
                    <table border="0" cellpadding="0" cellspacing="18" class="vb-container fullpad" style="border-collapse: separate;border-spacing: 18px;padding-left: 0;padding-right: 0;width: 100%;max-width: 570px;" width="770">
                        <tbody>
                        <tr>
    ...
    <table bgcolor="#fff" border="0" cellpadding="0" cellspacing="0" class="vb-outer" id="ko_titleBlock_3" style="background-color: #fff;" width="100%">
        ...
        <tr>
            <td align="center" bgcolor="#fff" class="vb-outer" style="padding-left: 9px;padding-right: 9px;background-color: #fff;" valign="top">
                <!--[if (gte mso 9)|(lte ie 8)]><table align="center" border="0" cellspacing="0" cellpadding="0" width="570"><tr><td align="center" valign="top"><![endif]-->
                <div class="oldwebkit" style="max-width: 570px;">
                    <table bgcolor="#FFFFFF" border="0" cellpadding="0" cellspacing="9" class="vb-container halfpad" style="border-collapse: separate;border-spacing: 9px;padding-left: 9px;padding-right: 9px;width: 100%;max-width: 420px;background-color: #fff;" width="770">
                        <tbody>
                        <tr>
                            <td align="center" bgcolor="#FFFFFF" colspan="2" style="background-color: #ffffff; font-size: 22px; font-family: Verdana, Geneva, sans-serif; color: #3f3f3f; text-align: center;"><span>Hai {{ $user-&gt;first_name . ' ' . $user-&gt;last_name }}</span><br>
                                <span>Berikut ini adalah surat perjanjian dalam transaksi dengan nomor invoice {{ $transaction->invoice }}</span></td>
                        </tr>
                        </tbody>
                    </table>
                </div><!--[if (gte mso 9)|(lte ie 8)]></td></tr></table><![endif]-->

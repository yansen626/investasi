                        ...
                        <div class="x_content">
                            ...
                            <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                                ...
                                <tr>
                                    ...
                                    <th>Total Payment</th>
                                    <th>Order Date</th>
                                    <th>VA to RDN Date</th>
                                    <th>Option</th>
                                </tr>
                                </thead>
                                <tbody>
                                @php( $idx = 1 )
                                @foreach($twoDayTransfer as $trx)
                                    <tr>
                                        <td>{{ $idx }}</td>
                                        <td>{{ $trx->invoice }}</td>
                                        ...
                                        <td>
                                            {{ \Carbon\Carbon::parse($trx->two_day_due_date)->format('j F Y')}}</td>
                                        <td>
                                            <a onclick="modalPop('{{ $trx->id }}', 'accept', '/admin/VAtoRDN/accept/')" class="btn btn-success">Accept</a>

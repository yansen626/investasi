                        ...
                        <div class="x_content">
                            ...
                            <div class="col-md-9 col-sm-9 col-xs-12">
                                ...
                                <div>
                                    ...
                                    <ul class="messages">
                                        <li>
                                            <img src="{{ asset('storage\owner_picture\\'.$owner->profile_picture) }}" class="avatar" alt="Avatar">
                                            ...
                                            <div class="message_wrapper">
                                                ...
                                                <blockquote class="message">{!! $owner->description !!}</blockquote>
                                                <br />
                                            </div>
                                        </li>
                                    </ul>
                                       ...
                                       {{-- <br />
                                        ...
                                        @if($product->status_id == 3)
                                            <div class="text-center mtop20">
                                                <a onclick="modalPop('{{ $product->id }}', 'accept', '/admin/owner/accept/')" class="btn btn-sm btn-primary">Accept</a>
                                                <a onclick="modalPop('{{ $product->id }}', 'cancel', '/admin/owner/reject/')" class="btn btn-sm btn-warning">Reject</a>
                                            </div>
                                        @endif
                                    </div>
